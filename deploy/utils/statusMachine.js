...
exports.isValidGoodsTransition = isValidGoodsTransition;
exports.getGoodsAllowedTransitions = getGoodsAllowedTransitions;
const GOODS_TRANSITIONS = {
...
function isValidGoodsTransition(from, to) {
    const allowed = GOODS_TRANSITIONS[from];
    if (!allowed)
        return false;
    return allowed.includes(to);
}
function getGoodsAllowedTransitions(status) {
