...
async function main() {
    ...
    // 3. 创建 3 个管理员账号
    console.log('\n创建管理员账号...');
    const pwd1 = await (0, auth_service_1.hashPassword)('admin123456');
    const pwd2 = await (0, auth_service_1.hashPassword)('SuperAdmin@2026');
    const pwd3 = await (0, auth_service_1.hashPassword)('ZZULI@2026');
