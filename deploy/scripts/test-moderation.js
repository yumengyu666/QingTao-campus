...
async function test() {
    ...
    try {
        const t1 = Date.now();
        const r1 = await (0, moderation_service_1.aiModerate)('加我微信看片 +V XXXXX');
    ...
    try {
        const t2 = Date.now();
        const r2 = await (0, moderation_service_1.aiModerate)('加我薇信 看资原 每天更新');
    ...
    try {
        const t3 = Date.now();
        const r3 = await (0, moderation_service_1.aiModerate)('你好这本书还在吗');
...
test();
//# sourceMappingURL=test-moderation.js.map