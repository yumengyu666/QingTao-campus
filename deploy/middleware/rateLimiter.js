...
exports.commentLimiter = exports.searchLimiter = exports.uploadLimiter = exports.agentLimiter = exports.sensitiveOpLimiter = exports.publishLimiter = exports.registerLimiter = exports.loginLimiter = exports.globalLimiter = void 0;
...
exports.registerLimiter = (0, express_rate_limit_1.default)({
    windowMs: 60 * 1000,
    max: env_1.env.RATE_REGISTER_MAX,
    standardHeaders: true,
    legacyHeaders: false,
    message: { code: 429, message: '注册过于频繁，请1分钟后再试', data: null },
});
// 发布限制：每用户每分钟N次（已登录按userId，未登录按IP）
exports.publishLimiter = (0, express_rate_limit_1.default)({
    windowMs: 60 * 1000,
    max: env_1.env.RATE_PUBLISH_MAX,
    standardHeaders: true,
    legacyHeaders: false,
