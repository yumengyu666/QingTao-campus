...
const ctrl = __importStar(require("../controllers/barter.controller"));
const router = (0, express_1.Router)();
router.use(auth_1.authMiddleware);
router.post('/', (0, moderation_middleware_1.moderateBody)(['message']), ctrl.proposeBarter);
router.get('/', ctrl.getProposals);
router.patch('/:id/accept', ctrl.acceptBarter);
router.patch('/:id/reject', ctrl.rejectBarter);
exports.default = router;
//# sourceMappingURL=barter.routes.js.map